...
/// AuthFlow DSL top-level structure
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AuthFlowDSL {
    /// DSL version
    #[serde(default)]
    pub version: Version,
...
impl AuthFlowDSL {
    /// Parse AuthFlow DSL from a YAML string
    pub fn from_yaml(yaml: &str) -> Result<Self> {
        serde_yaml::from_str(yaml)
            .map_err(|e| anyhow!("Failed to parse AuthFlow DSL: {}", e))
    }

    /// Parse AuthFlow DSL from a JSON string
    ...
    pub fn to_yaml(&self) -> Result<String> {
        serde_yaml::to_string(self)
            .map_err(|e| anyhow!("Failed to serialize AuthFlow DSL to YAML: {}", e))
    }

    /// Convert to a JSON string
    pub fn to_json(&self) -> Result<String> {
        serde_json::to_string_pretty(self)
            .map_err(|e| anyhow!("Failed to serialize AuthFlow DSL to JSON: {}", e))
    }
...
mod tests {
    ...
    #[test]
    fn test_authflow_dsl_validation() {
    ...
    fn test_json_serialization() {
        ...
        let dsl = AuthFlowDSL {
            ...
            metadata: Some(Metadata {
                ...
                author: Some("AuthFlow Team".to_string()),
        ...
        let parsed_dsl = AuthFlowDSL::from_json(&json_str).unwrap();
