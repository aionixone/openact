...
pub fn core_api_router() -> Router {
    ...
    Router::new()
        ...
        .route("/api/v1/connections/{trn..}/status", get(crate::server::handlers::connections::status))
        .route("/api/v1/connections/{trn..}/test", post(crate::server::handlers::connections::test))
        ...
        .route("/api/v1/execute/adhoc", post(crate::server::handlers::execute::execute_adhoc))
        // Connect flows
        .route("/api/v1/connect", post(crate::server::handlers::connect::connect))
        .route("/api/v1/connect/ac/resume", post(crate::server::handlers::connect::connect_ac_resume))
        .route("/api/v1/connect/ac/status", get(crate::server::handlers::connect::connect_ac_status))
        .route("/api/v1/connect/device-code", post(crate::server::handlers::connect::connect_device_code))
